...
define("ember-app/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "aD5rnJ/t", "block": "{\"symbols\":[],\"statements\":[[6,\"div\"],[10,\"class\",\"ember-view\"],[8],[0,\"\\n\"],[0,\"  \"],[1,[20,\"welcome-page\"],false],[0,\"\\n\"],[0,\"  \\n  \"],[1,[20,\"outlet\"],false],[0,\"\\n\"],[9]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/application.hbs" } });
});
...
if (!runningTests) {
  require("ember-app/app")["default"].create({"name":"ember-app","version":"0.0.0+4c827ec9"});
}
